...
class _WeatherApiClient implements WeatherApiClient {
  ...
  Future<WeatherOneAndAHalfDaysEntity> get36hForecast({
    ...
    final _options = _setStreamType<WeatherOneAndAHalfDaysEntity>(
    ...
    late WeatherOneAndAHalfDaysEntity _value;
    try {
      _value = WeatherOneAndAHalfDaysEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
